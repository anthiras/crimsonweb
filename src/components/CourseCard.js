...
const CourseCard = ({ t, course, setParticipationStatus, toggleSignupModal, signup, cancelSignup }) => {
    ...
    const bgClass = status === "pending" ? "bg-success text-white" : "bg-light";
    const mutedClass = status === "pending" ? "" : "text-muted";
    return (
        <div className={"card mb-4 "+bgClass}>
            <div className="card-body">
                ...
                <CourseSignUp course={course} setParticipationStatus={setParticipationStatus}
